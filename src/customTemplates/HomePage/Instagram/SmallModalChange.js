            ...
            {data && (
              <React.Fragment>
                <div className="img-box">
                  {renderLazyImage(
                    data.alt,
                    data.bigImg.replace('.jpg', '_400x.jpg'),
                    data.bigImg.replace('.jpg', '_828x.jpg'),
                  )}
                </div>
                        ...
                        {baseProductData.handle === props.handle && (
                          <Swiper {...gift_slide} getSwiper={setSwiper}>
                            {baseProductData.images.edges.map((item, i) => {
                              return (
                                <span key={i}>
                                  <img src={item.node.originalSrc} loading="lazy" alt={item.alt} />
                                </span>
                              );
                            })}
                          </Swiper>
                      ...
                      <div className="clothe-photos">
                        {data.originalSrc ? (
                          ...
                          data.originalImgas.map((item, i) => (
                            <span key={i}>
                              {item.handle === baseProductData.handle && <img src={item.originalSrc} />}
                            </span>
                          ))
                        )}
                      </div>
