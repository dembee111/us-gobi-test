...
function SortByShell({ items, refine, currentRefinement, mobile }) {
        ...
        {items.map((item, key) => {
          return (
            ...
            >
              ...
              >
                <div className={item.isRefined ? 'filterSortBoxChecked' : 'filterSortBox'}>
...
const SortBy = connectSortBy(SortByShell);
