...
function SizeRefineMentListShell({ items, refine, currentRefinement, sizeFilters, mobile }) {
    ...
    if (itemsClone) {
      ...
      for (let singleApprovedItem of approvedItems) {
        ...
        for (let singleApprivedSize of singleApprovedItem.size) {
          for (let singleRefinement of currentRefinement) {
            if (singleRefinement === singleApprivedSize) {
...
const SizeRefineMentList = connectRefinementList(React.memo(SizeRefineMentListShell));

export default SizeRefineMentList;
