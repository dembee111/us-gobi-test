    ...
    <div>
      <div id="womenSection">
        ...
        <section className="w3-section">
          {w4Data.map((list, index) => {
            return (
              <div key={index} className="grid-c">
        ...
        <section className="w2-section bg-color-1 padding-300">
          <div className="title-pos">
            <h1>A CROWD FAVORITE</h1>
          </div>
          {w6Data.map((list, index) => {
            return (
              <div key={index} className="grid-2">
                <div className="l-sec">
                  <div className="single-img">
        ...
        <section className="w21-section margin-top-300">
          <div className="grid-3">
            {w7Data.map((list, index) => {
              return (
                <div key={index} className={'single-img' + list.style2}>
                  <div className="img-box">
                    <Link to={list.handle}>
