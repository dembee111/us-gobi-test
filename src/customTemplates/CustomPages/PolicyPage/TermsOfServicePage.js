    ...
    <div className="return-policy-section">
      ...
      <div className="container-fluid-policy">
        ...
        <div className="section-body">
          <h2 className="first-h"> OVERVIEW </h2>

          <p>
            This website is operated by GOBI MONGOLIAN CASHMERE USA CORP. Throughout the site, the terms “we”, “us” and
            “our” refer to GOBI MONGOLIAN CASHMERE USA CORP. GOBI MONGOLIAN CASHMERE USA CORP offers this website,
          ...
          <p>
            ...
            your jurisdiction (including but not limited to copyright laws). You must not transmit any worms or viruses
            or any code of a destructive nature. A breach or violation of any of the Terms will result in an immediate
          ...
          <p>
            ...
            without notice at any time. <br></br>
          ...
          <p>
            ...
            Policy. <br></br>
            Due to the many variations in computer monitors and the different lightings for each setting (i.e. studio
            lighting vs outdoor lighting), the colors of the product may appear differently. Monitors are not all
            calibrated equally and color reproduction on the Internet is not precise. Therefore, it is not possible to
            guarantee our online colors will look the same on all computers hence we cannot guarantee that what you see
            accurately portrays the color of the actual product. We do our very best to make sure our colors are as
            close to the exact product as possible, but cannot guarantee that what you see is an exact replica.
            <br></br>
          ...
          <h2>SECTION 7 - SHIPPING, CUSTOMS AND REGULATIONS</h2>
          <p>
          ...
          <h2>SECTION 8 - SALES PROMOTIONS</h2>
          <p>
            At the end of GOBI’s promotions or sales offers, any following offers may hold the same or similar sales
            amount or offered products. In addition, each can have a varying duration date with a differing sales
            concept.
          </p>
          <p>
            All reduced-price items are non-refundable and non-returnable. Gobi Cashmere is not obliged to price match
            any reduced price offers.
          </p>

          <h2>SECTION 9 - OPTIONAL TOOLS </h2>
          ...
          <p>
            ...
            liability whatsoever arising from or relating to your use of optional third-party tools. <br></br>
            ...
            relevant third-party provider(s). <br></br>
          ...
          <p>
            ...
            order). We undertake no obligation to update, amend or clarify information in the Service or on any related
          ...
          <p>
            ...
            merchantable quality, fitness for a particular purpose, durability, title, and non-infringement. In no case
            shall Gobi Cashmere USA, our directors, officers, employees, affiliates, agents, contractors, interns,
          ...
          <p>
            You agree to indemnify, defend and hold harmless Gobi Cashmere USA and our parent, subsidiaries, affiliates,
          ...
          <p>
            ...
            may terminate this agreement at any time without notice and you will remain liable for all amounts due up to
            and including the date of termination; and/or accordingly may deny you access to our Services (or any part
            thereof).
          </p>
          ...
          <p>Questions about the Terms of Service should be sent to us at support-2@gobicashmere.com</p>
        </div>
      </div>
    </div>
  );
