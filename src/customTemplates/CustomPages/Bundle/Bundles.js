...
import './Bundle.scss';
import { bundlesList, herBundleList, himBundleList, coupleBundleList } from './bundleData';
      ...
      <div className="tc-container">
        <div className="bundle-collection">
          <div className="b-title">
            <h1>Valentines Special Bundles</h1>
          </div>
          <div className="b-grid-col">
            {/* {bundlesList.map((bundle, index) => {
              return (
                <div key={index}>
                  {bundle.child.map((bundle, index) => {
                    return(
            ...
            {herBundleList.map((bundle, index) => {
              return (
                <div key={index} className="b-col-item">
                  <Link to={'/bundles/' + bundle.handle}>
                    <div className="b-widget">
            ...
            {coupleBundleList.map((bundle, index) => {
              return (
                <div key={index} className="b-col-item">
                  <Link to={'/bundles/' + bundle.handle}>
                    <div className="b-widget">
