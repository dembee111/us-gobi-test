...
import { addGiftToCart } from '../../components/shared/cart/CartHelpers';

const SideDrawer1 = (props) => {
...
export default connect(mapStateToProps)(SideDrawer1)