                ...
                <div className="tc_table">
                  ...
                  <div className="tBody">
                    <div className="tB_list">
                      ...
                      <div className="tb pr">${props.details[0].currentSubtotalPriceSet.presentmentMoney.amount}</div>
                    </div>
                    {/* <div className="tB_list">
                    ...
                    <div className="tB_list">
                      ...
                      <div className="tb">
                        <span>Standard Shipping (0.438 kg)</span>
                      </div>
